...
func _build_scenes() -> void:
	scenes = {
		...
		"school_hallway": {
			...
			"theme": "school",
			"player_position": Vector2(730, 690),
			"bounds": Rect2(180, 560, 1240, 160),
			"character_scale": 0.78,
				"interactables": [
					{"id": "volunteer_board", "name": "志愿填报栏", "position": Vector2(760, 585), "kind": "board", "dialogue": "d_volunteer_board", "label": "志愿填报"},
					{"id": "linzhou", "name": "林舟", "position": Vector2(585, 665), "kind": "npc", "dialogue": "d_linzhou_hallway", "label": "林舟"},
					{"id": "zhouxiao_hallway", "name": "周骁", "position": Vector2(470, 685), "kind": "npc", "dialogue": "d_zhouxiao_hallway", "label": "周骁"},
					{"id": "heqilang_hallway", "name": "何启朗", "position": Vector2(870, 665), "kind": "npc", "dialogue": "d_heqilang_hallway", "label": "何启朗"},
					{"id": "shenyou_hallway", "name": "沈柚", "position": Vector2(980, 670), "kind": "npc", "dialogue": "d_shenyou_hallway", "label": "沈柚"},
					{"id": "chenwang_hallway", "name": "陈望", "position": Vector2(1270, 680), "kind": "npc", "dialogue": "d_chenwang_hallway", "label": "陈望"},
					{"id": "teacher", "name": "班主任", "position": Vector2(1125, 650), "kind": "npc", "dialogue": "d_teacher_hallway", "label": "班主任"},
					{"id": "ai_notice", "name": "智能通知", "position": Vector2(1390, 590), "kind": "ai_panel", "dialogue": "d_ai_notice", "label": "AI建议"},
				],
				"npcs": [
					{"id": "linzhou_npc", "name": "林舟", "position": Vector2(585, 665), "role": "student_dark"},
					{"id": "zhouxiao_npc", "name": "周骁", "position": Vector2(470, 685), "role": "student_alt"},
					{"id": "heqilang_npc", "name": "何启朗", "position": Vector2(870, 665), "role": "student_clean"},
					{"id": "shenyou_npc", "name": "沈柚", "position": Vector2(980, 670), "role": "student_college"},
					{"id": "chenwang_npc", "name": "陈望", "position": Vector2(1270, 680), "role": "student_alt"},
					{"id": "teacher_npc", "name": "班主任", "position": Vector2(1125, 650), "role": "teacher"},
				],
			},
		"computer_room": {
			"chapter": "chapter_1",
			...
			"theme": "graduation",
			"player_position": Vector2(760, 670),
			"bounds": Rect2(70, 600, 1460, 115),
				"interactables": [
			...
			"npcs": [
					{"id": "linzhou_grad", "name": "林舟", "position": Vector2(330, 650), "role": "student_dark"},
					{"id": "zhouxiao_grad", "name": "周骁", "position": Vector2(1075, 675), "role": "student_alt"},
					{"id": "heqilang_grad", "name": "何启朗", "position": Vector2(1310, 665), "role": "student_clean"},
					{"id": "shenyou_grad", "name": "沈柚", "position": Vector2(895, 650), "role": "student_college"},
					{"id": "chenwang_grad", "name": "陈望", "position": Vector2(1195, 675), "role": "student_alt"},
				],
			},
			"bridge_sunset_transition": {
				"chapter": "chapter_2",
				"location": "傍晚桥边",
				"time": "18:42",
				"objective": "看着城市夕阳，准备去大学报到",
				"entry_hint": "看向远处城市，再继续去大学报到",
				"narration": "n_bridge_sunset_transition",
				"theme": "bridge_sunset_first_person",
				"hide_player": true,
				"hide_hud": true,
				...
				"interactables": [
					{"id": "bridge_to_campus", "name": "去大学报到", "position": Vector2(800, 610), "kind": "door", "dialogue": "d_bridge_to_campus", "label": "继续"},
				],
				"npcs": [],
			},
			"university_campus": {
			...
			"theme": "interview",
			"player_position": Vector2(755, 730),
			"bounds": Rect2(165, 640, 1265, 150),
			"interactables": [
				{"id": "interviewer_chair", "name": "面试官", "position": Vector2(455, 650), "kind": "npc", "dialogue": "d_interview_opening", "label": "面试官", "hide_marker_visual": true},
				{"id": "realtime_prompt", "name": "实时提示面板", "position": Vector2(800, 620), "kind": "ai_panel", "dialogue": "d_interview_ai_prompt", "label": "实时提示", "hide_marker_visual": true},
				{"id": "interview_start", "name": "开始结构化面试", "position": Vector2(1275, 650), "kind": "pressure", "pressure": "interview_pressure", "label": "正式面试", "hide_marker_visual": true},
			],
			"npcs": [],
			},
			"offer_arrival": {
...
func _build_dialogue() -> void:
	dialogue_nodes = {
		...
		"n_bridge_sunset_transition": {
			"speaker": "旁白",
			"line": "桥上的风比操场安静。远处城市正在落日里发亮，你第一次觉得离开不是一瞬间，而是一段没人替你按下继续的停顿。",
		},
		"n_university_campus": {
			"speaker": "旁白",
		...
		"d_vertical_slice_ending": {
			...
			"choices": [
				_choice("slice_summary", "查看 Chapter 0-2 结算", STRATEGY_SAFE, "纵切结束：你建立了成功路径基础，也留下了会在后续章节回来的选择。录取通知和新生项目邮件同时抵达。", {"flags": {"vertical_slice_complete": true}}),
					_choice("slice_to_campus_self", "带着旧留言去大学报到", STRATEGY_SELF, "你把毕业留言纸条夹进电脑包。大学中庭的项目招募屏已经亮起。", {"stats": {"clarity": 3}, "flags": {"vertical_slice_complete": true, "entered_college": "self"}, "wishes": {"complete": ["写下毕业留言"], "current": "完成第一次团队项目"}, "settlement": {"id": "ch2_photo", "title": "毕业照结算", "body": "青春告别第一次被成功路径整理成阶段总结。你仍记得几句无法放进总结里的话。"}}, "bridge_sunset_transition"),
					_choice("slice_to_campus_ai", "让 AI 规划大学第一周", STRATEGY_AI, "AI 把社团、竞赛、绩点和人脉排成一张表。你按照最优路线走进大学中庭。", {"stats": {"ai_dependence": 3, "resume_score": 2}, "flags": {"vertical_slice_complete": true, "entered_college": "ai"}, "emotion_cards": {"add": ["AI 已规划今日"]}, "wishes": {"complete": ["写下毕业留言"], "current": "完成第一次团队项目"}, "settlement": {"id": "ch2_photo_ai", "title": "毕业照结算", "body": "留言很完整，照片也很体面。系统把下一阶段排好了，某些原本想说的话没有再出现。"}, "ai_stage": 2}, "bridge_sunset_transition"),
			],
		},
		"d_bridge_to_campus": {
			"speaker": "旁白",
			"line": "夕阳沉到楼群后面，录取通知和新生报到邮件同时亮起。你把手从栏杆上收回来，走向那座更大的城市。",
			"choices": [
				_choice("bridge_continue_to_campus", "去大学报到", STRATEGY_SELF, "大学中庭的项目招募屏已经亮起。", {}, "university_campus"),
			],
		},
